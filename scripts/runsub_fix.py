...
class SubSession():
    ...
    args = parser.parse_args()
      ...
      def __init__(self, internet_address = ' ', manual = ' ', state_machine = ' ', network_model = ' ', verbosity = ' ', no_arduino = ' ', no_network = ' ', no_save_images = ' ', debug_execute = ' ', start_front_network = ' ', start_bottom_network = ' '):
        # Subprocesses:
        self.curr_children = []

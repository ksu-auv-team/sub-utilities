...
class SubSession():
    ...
    def start(self):     
        # Run the Video Node
        self.curr_children.append(self.start_video(args))
        ...
        if(args.manual):
            ...
            self.curr_children.append(self.start_execute(args))
...
if __name__ == '__main__':
    ...
    if args.no_arduino:
        if(not args.no_network):
            go_sub_go.startup_processes.append(go_sub_go.start_network(args))
        time.sleep(3)
        go_sub_go.start()
